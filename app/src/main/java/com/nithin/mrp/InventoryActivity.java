...
public class InventoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new CustomAdapter(dataholder);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item){
        ...
        switch (item.getItemId()){
            case R.id.action_ascending:
                ...
                Toast.makeText(InventoryActivity.this, "Name In Ascending Order", Toast.LENGTH_SHORT).show();
                return true;
            case R.id.action_descending:
                Collections.sort(dataholder, Model.descPname);
                mAdapter.notifyDataSetChanged();
                Toast.makeText(InventoryActivity.this, "Name In Descending Order", Toast.LENGTH_SHORT).show();
                return true;

            case R.id.action_ascprice:
                Collections.sort(dataholder, Model.ascPrice);
                mAdapter.notifyDataSetChanged();
                Toast.makeText(InventoryActivity.this, "Price In Ascending Order", Toast.LENGTH_SHORT).show();
                return true;

            case R.id.action_descprice:
                Collections.sort(dataholder, Model.descPrice);
                mAdapter.notifyDataSetChanged();
                Toast.makeText(InventoryActivity.this, "Price In Descending Order", Toast.LENGTH_SHORT).show();
                return true;
        }
